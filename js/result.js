...
$(document).ready(function() {
    ...
    $(document).on("click", "input[type='button']", function () {
        ...
        if (value == '벽지') {
            ...
            output_body_link = "https://smartstore.naver.com/roomstore/products/3804207079";
        } else if (value == '책상') {
            output_body_text = "제품 명 : 조립식 노트북 공부 컴퓨터 긴 원룸 전면 나무 책상";
            output_body_link = "https://smartstore.naver.com/gowoostore/products/8233142118";
        }

        // 모달에 텍스트 삽입
        $("#modal-explain-area").text(output_body_text);

        $("#modal-link-area").html(
            '<button class="btn btn-success" onclick="window.location.href=\'' + output_body_link + '\'">바로 가기</button>'
        );
